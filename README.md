...
The selling generator stay formerly on v0.5.0 in current development . 

The experimental branch v0.6.0 is acquiring new contexts explorations . 

Some recent results in infinite/discreet domain coverage : 
...
actual v30 of parallel formal progression is : v30 - Compact dlt pair, relative Picard-Lefschetz, recollement reflection and marked stringy splitting
